...
//        -----------------------------------------------------------
        ...
        txtNama.setText("<------ ------>");
        txtAlamat.setText("Klik FORM untuk mengisi Biodata");
        ...
        txtNama.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity.this,
                        "Anda menekan tulisan Nama " + txtNama.getText(),
        ...
        txtAlamat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity.this,
                        "Anda menekan tulisan Alamat " + txtAlamat.getText(),
                        Toast.LENGTH_SHORT).show();
        ...
        txtHW.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                jumlah++;
                Toast.makeText(MainActivity.this,
                        "Anda menekan tulisan HW Sebanyak " + jumlah + " kali",
                        Toast.LENGTH_SHORT).show();
